...
@section('content')		
			<section>
				<h1 class="textos_secciones">Editar Profesor</h1>
				<form method="post" id="formulario_editar_profesor">
				@method('PATCH')
				{{ csrf_field() }}
					<div class="form-row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label class="texto_campo_formulario">Apellido</label>
							<input type="text" name="apellido" class="form-control" value="{{ $profesor->apellido }}">
					...
					<div class="form-row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" name="dni" class="form-control" maxlength="8" value="{{ $profesor->dni }}">
							<div id="mensaje_dni"></div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label class="texto_campo_formulario">Direccion</label>
							<input type="text" name="direccion" class="form-control" value="{{ $profesor->direccion }}">
					...
					<div class="form-row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" name="pais" class="form-control" value="{{ $profesor->pais }}">
							<div id="mensaje_pais"></div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label class="texto_campo_formulario">Ciudad</label>
							<input type="text" name="ciudad" class="form-control" value="{{ $profesor->ciudad }}">
					...
					<div class="form-row">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" name="fecha_nacimiento" id="datepicker" readonly="true" class="form-control" value="{{ $profesor->fecha_nacimiento }}">
					...
					<div class="form-row">						
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" name="telefono" class="form-control" value="{{ $profesor->telefono }}">
							<div id="mensaje_telefono"></div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label class="texto_campo_formulario">Categoria</label>
							<input type="text" name="categoria" class="form-control" value="{{ $profesor->categoria }}">
